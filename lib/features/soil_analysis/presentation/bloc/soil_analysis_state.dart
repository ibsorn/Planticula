...
class SoilAnalysisState extends Equatable {
  ...
  SoilAnalysisState copyWith({
    ...
    Object? selectedAnalysis = _absent,
    Object? lastCreatedAnalysis = _absent,
    ...
    return SoilAnalysisState(
      ...
      selectedAnalysis: selectedAnalysis == _absent ? this.selectedAnalysis : selectedAnalysis as SoilAnalysis?,
      lastCreatedAnalysis: lastCreatedAnalysis == _absent ? this.lastCreatedAnalysis : lastCreatedAnalysis as SoilAnalysis?,
